...
EXP_DIR = BASE_DIR + '/../experiments/mjc_chess_grip_experiment_old/'
...
agent = {
    'type': AgentMuJoCo,
    'filename': './mjc_models/walker.xml',
    'x0': np.concatenate([np.array([0.0, 1.25, 0.0, 0.0]),
                          np.zeros(5+9)]),
    ...
    'pos_body_offset': [np.array([0.0, 0.0, 0])],
    'T': 150,
    ...
    'camera_pos': np.array([-2., 1., 2., 0., 0.2, 0.5]),
}
...
fk_cost = {
    'type': CostFK,
    'target_end_effector': np.array([0.0, 0.0, 1.25]),
    'wp': np.array([1, 1, 1]),
    'l1': 0.1,
    'l2': 10.0,
    'alpha': 1e-5,
